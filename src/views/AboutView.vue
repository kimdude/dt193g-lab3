    ...
    <section>
        <div>
            ...
            <p>
                ...
                finns. Jag har än så länge inte riktigt förstått poängen med det och blir förvirrad över filvägen.
            </p>
            <p> Trots det har det varit väldigt kul att arbeta med Vue.js och jag kommer nog testa det fler gånger framöver!</p>
        </div>
    </section>
</template>
